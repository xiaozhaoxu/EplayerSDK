...
public class StorageUtil {
    ...
    public static String getCacheDir() {
        return EplayerConfigBuilder.getInstance().getContext().getCacheDir() + "/" + EplayerConfigBuilder.getInstance().getApp_identity() +"/";
    }

    //获取应用根目录
    public static String getStorageDirectory() {
        return Environment.getExternalStorageDirectory()+ "/" + EplayerConfigBuilder.getInstance().getApp_identity()+"/";
    }
    ...
    public static String getUploadCacheDierctory(){
        return  getAPPCacheDierctory()+"upload/";
    }
...
//        }
        ...
        String external = EplayerConfigBuilder.getInstance().getContext().getCacheDir().getPath();
    ...
    public static void cleanAll() {
        try {
            if (new File(EplayerConfigBuilder.getInstance().getContext().getCacheDir() + "/").exists())
                FileUtils.cleanDirectory(new File(EplayerConfigBuilder.getInstance().getContext().getCacheDir() + "/"));
            String external = Environment.getExternalStorageDirectory().getPath();
            if (new File(external + "/." + EplayerConfigBuilder.getInstance().getApp_identity() + "/Content/").exists())
                FileUtils.cleanDirectory(new File(external + "/." + EplayerConfigBuilder.getInstance().getApp_identity() + "/Content/"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
//    }
    ...
    public static String[] listFiles(String path, String suffix) {
        if (path.startsWith(ROOT_ASSET)) {
            ...
            AssetManager assetManager = EplayerConfigBuilder.getInstance().getContext().getAssets();
    ...
    public static void cleanCache() throws IOException {
        FileUtils.cleanDirectory(EplayerConfigBuilder.getInstance().getContext().getCacheDir());
    }
