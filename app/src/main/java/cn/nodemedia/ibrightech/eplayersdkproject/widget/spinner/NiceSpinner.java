package cn.nodemedia.ibrightech.eplayersdkproject.widget.spinner;
...
import cn.nodemedia.ibrightech.eplayersdkproject.R;
...
//            defaultPadding);
        setPadding(defaultPadding, 0, 0,
                0);
        setClickable(true);

        backgroundSelector = typedArray.getResourceId(R.styleable.NiceSpinner_backgroundSelector, R.drawable.sdk_nicespinner_selector);
...
//            popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.sdk_spinner_drawable));
//        } else {
//            popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, R.drawable.drop_down_shadow));
//        }

        popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(context, R.color.my_transparent));
        ...
        if (!isArrowHide) {
            Drawable basicDrawable = ContextCompat.getDrawable(context, R.drawable.sdk_nicespinner_arrow);
    ...
    public <T> void attachDataSource(@NonNull List<T> dataset) {
        adapter = new NiceSpinnerAdapter<T>(getContext(), dataset, textColor, backgroundSelector);
    ...
    public void showDropDown() {
        ...
        popupWindow.showAsDropDown(this,0,0-this.getHeight());
    }
